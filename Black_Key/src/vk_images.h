...
namespace vkutil {
	...
	AllocatedImage create_image_empty(VkExtent3D size, VkFormat format, VkImageUsageFlags usage, VulkanEngine* engine, VkImageViewType viewType = VK_IMAGE_VIEW_TYPE_2D, bool mipmapped = false, int layers = 1);
